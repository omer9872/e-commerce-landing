...
export const Footer = () => {
  ...
  return (
    <footer className="bg-light dark:bg-black border-t border-b-0 border-l-0 border-r-0 border-solid border-light-border dark:border-dark-border text-light-text dark:text-dark-text">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-row gap-3 justify-start items-start flex-wrap">
              {Object.entries({
                facebook: "#",
                twitter: "#",
                instagram: "#",
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                <svg
                  className="min-w-5 min-h-5 max-w-5 max-h-5 mr-2"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 dark:border-gray-900 mt-12 pt-8 text-center text-gray-700 dark:text-gray-300">
          <p>
            {t("footer.copyright", { year: new Date().getFullYear(), name: "tiksatis" })}
          </p>
        </div>
      </div>
    </footer>
